...
- Context docs live in `docs/orgs/<context-slug>/`; example contexts are `org-a` and `org-b`.
- Project docs live in `docs/orgs/<context-slug>/projects/<project-slug>/`.
- Service detail lives under `docs/orgs/<context-slug>/projects/<project-slug>/environments/<environment-slug>/services/<service-slug>.md`.
