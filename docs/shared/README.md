...
Use this directory for cross-org and Dokploy instance-level documentation.
...
- `mutation-safety.md`: canonical approval and preflight rules for live changes.
- `naming-conventions.md`: naming and path rules for orgs, projects, environments, services, backups, and credentials.
...
- `incident-runbook.md`: cross-org incident response workflow.
