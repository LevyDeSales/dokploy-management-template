# Alltius Organization

Use this directory for documentation specific to the Alltius organization in `https://dokploy.alltius.dev`.

## Operating Context

- CLI wrapper: `scripts/dokploy-cli.sh alltius ...`
- MCP server: `dokploy-alltius-org-alltius`
- Credential label: `dokploy-alltius-org-Alltius`
- Local env var: `DOKPLOY_ALLTIUS_ORG_ALLTIUS_API_KEY`
